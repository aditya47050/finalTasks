...
const MobileTreatmentFilter = forwardRef((_, ref) => {
  ...
  return (
    <>
      <div
        ref={toggleRef}
        className=" md:hidden w-full max-w-xs mx-auto my-4 z-10 relative flex justify-center"
      >
        <button
...
MobileTreatmentFilter.displayName = "MobileTreatmentFilter";
export default MobileTreatmentFilter;
