  ...
  return (
    <main className="min-h-dvh bg-background flex items-center justify-center p-6">
      ...
      >
        ...
        >
          <motion.img
            src="https://res.cloudinary.com/dorreici1/image/upload/v1756897549/d90f4c19-f51b-4cbf-a9eb-ad91af730f52.png"
            alt="Doctor-centered care illustration"
          ...
          <span
            aria-hidden="true"
            className="pointer-events-none absolute top-6 left-1 h-4 w-4 rounded-full bg-blue-600/70 animate-ping [animation-duration:3s]"
          />
        </motion.div>
        ...
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="px-[24px] space-y-3">
          <Button asChild className=" w-full bg-blue-600 text-white rounded-xl hover:bg-blue-600/90">
            <Link href="/mobile/doctor/login">Continue to Doctor login</Link>
          </Button>
