...
const BookHomeHealthcareDialog = ({ open, onOpenChange, patientId, homeHealthcareId, serviceName }) => {
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/home-healthcare/bookservice", {
        method: "POST",
      ...
      if (data.success) {
        toast.success("Home healthcare service booked successfully!");
        onOpenChange(false);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg bg-white p-6 rounded-xl shadow-xl">
        <DialogHeader className="text-center pb-4">
          <HeadingClientMain main={`Book ${serviceName}`} />
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              rows={3}
              placeholder="Add any special instructions or medical requirements (optional)"
              value={notes}
...
export default BookHomeHealthcareDialog;