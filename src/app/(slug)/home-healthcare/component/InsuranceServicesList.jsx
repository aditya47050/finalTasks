...
const InsuranceServicesList = ({ onClose, homeHealthcareService, serviceName }) => {
  ...
  // Fetch insurance services from API
  useEffect(() => {
  ...
  const getServiceColor = (index) => {
    const colors = ["indigo", "blue", "purple", "teal", "cyan"];
    ...
    <div className="fixed inset-0 bg-black/50 z-50 overflow-y-auto">
      <div className="min-h-screen py-6 px-4">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="bg-gradient-to-r from-indigo-600 to-blue-600 rounded-t-xl shadow-lg p-6 sticky top-0 z-10">
              ...
              <div className="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card className="border-2 border-indigo-200 hover:shadow-lg transition-all">
                  <CardContent className="p-4 text-center">
                    ...
                    <h4 className="font-bold text-gray-900 text-2xl mb-1">{statistics.cashlessProviders}</h4>
              ...
              {[
                {
                  ...
                  desc: "No upfront payment needed",
                },
                {
                  icon: <Shield className="w-6 h-6 text-blue-600" />,
                  title: "Insurance Accepted",
                  desc: "All major insurers covered",
                },
                {
                  icon: <FileCheck className="w-6 h-6 text-purple-600" />,
                  title: "Quick Claims",
                  desc: "Fast claim processing",
                },
                {
                  icon: <Wallet className="w-6 h-6 text-teal-600" />,
                  title: "Cost Savings",
                  desc: "Reduce out-of-pocket costs",
                },
              ].map((feature, idx) => (
                      ...
                      >
                        <CardContent className="p-5">
                          ...
                          <div className="flex items-center gap-4 mb-4 text-xs text-gray-600">
                            ...
                            {service.totalBookings > 0 && (
                              <div className="flex items-center gap-1">
                                ...
                                <span>{service.totalBookings} Claim{service.totalBookings > 1 ? "s" : ""}</span>
                              </div>
                            )}
                          </div>
                          ...
                          <div className="space-y-2 mb-4">
                            {["Cashless Treatment", "All Major Insurers"].map((feature, idx) => (
                      ...
                      {[
                        {
                          ...
                          desc: "Get treatment without advance payment",
                        },
                        {
                          icon: <Shield className="w-5 h-5 text-blue-600" />,
                          title: "Coverage Protection",
                          desc: "Your insurance covers the costs",
                        },
                        {
                          icon: <FileCheck className="w-5 h-5 text-purple-600" />,
                          title: "Easy Process",
                          desc: "Simple documentation and claims",
                        },
                        {
                          icon: <Wallet className="w-5 h-5 text-teal-600" />,
                          title: "Cost Effective",
                          desc: "Significant savings on healthcare",
                        },
                      ].map((benefit, idx) => (
                        <div
                          key={idx}
