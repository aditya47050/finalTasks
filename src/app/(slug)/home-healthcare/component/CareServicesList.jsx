...
const CareServicesList = ({ onClose, homeHealthcareService, serviceName }) => {
  ...
  const getServiceColor = (index) => {
    const colors = ["pink", "rose", "red", "coral", "fuchsia"];
          ...
          <div className="bg-gray-50 rounded-b-xl shadow-lg p-6">
            ...
            {statistics && !loading && (
              <div className="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Card className="border-2 border-coral-200 hover:shadow-lg transition-all">
                  <CardContent className="p-4 text-center">
                    <div className="w-12 h-12 bg-coral-100 rounded-full flex items-center justify-center mx-auto mb-2">
            ...
            <div className="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
              {[
                ...
                },
                {
                  ...
                  title: "Home Comfort",
                  desc: "Care in familiar space",
                },
                {
                  icon: <HandHeart className="w-6 h-6 text-red-600" />,
                  title: "Compassionate",
                  desc: "Treating with love",
                },
                {
                  icon: <UserCheck className="w-6 h-6 text-coral-600" />,
                      ...
                      >
                        <CardContent className="p-5">
                          ...
                          <div className="flex items-center gap-4 mb-4 text-xs text-gray-600">
                            ...
                            {service.totalBookings > 0 && (
                              <div className="flex items-center gap-1">
                                ...
                                <span>{service.totalBookings} Patient{service.totalBookings > 1 ? "s" : ""}</span>
                              </div>
                            )}
                          </div>
                          ...
                          <div className="space-y-2 mb-4">
                            {["Personalized Care", "Compassionate Service"].map((feature, idx) => (
                      ...
                      {[
                        {
                          ...
                          desc: "Treating every patient with love and respect",
                        },
                        {
                          icon: <Home className="w-5 h-5 text-rose-600" />,
                          title: "Home Comfort",
                          desc: "Care in the comfort of your own home",
                        },
                        {
                          icon: <UserCheck className="w-5 h-5 text-red-600" />,
                          title: "Personalized Attention",
                          desc: "Tailored care plans for each patient",
                        },
                        {
                          icon: <HandHeart className="w-5 h-5 text-coral-600" />,
                          title: "Dedicated Support",
                          desc: "Focused, attentive healthcare professionals",
                        },
                      ].map((benefit, idx) => (
                        <div
                          key={idx}
