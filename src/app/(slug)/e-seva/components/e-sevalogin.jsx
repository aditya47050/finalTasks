...
const EsevaLoginClient = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const res = await fetch("/api/otps/loginsendotp", {
        ...
        body: JSON.stringify({ email, type: "eseva" }), // Only sending email for OTP
      });
  ...
  const handleSubmit = async (e) => {
    ...
    // }
    try {
      const res = await fetch("/api/e-seva/login", {
        method: "POST",
        headers: {
          "Content-Type": "application/json", // Important for JSON body
        },
        body: JSON.stringify({ email, password, mobile, role }),
      });
  ...
  return (
    <>
      ...
      <div className="hidden md:block font-poppins  justify-between mt-1 lg:pb-0 md:pb-0">
        <div className="justify-center font-poppins text-center ">
          ...
          <p className="text-[#5271FF] text-[15px] md:text-[20px] ">
            E-Seva/E-Seva SubAdmin/Asha Worker Login
          </p>
        </div>
        {/* Form and Details */}
              ...
              <div className="mx-auto container w-full lg:px-36  xl:px-64 rounded-xl">
                 <div className="w-full relative justify-center mt-4 flex flex-col items-center">  
                  <div className="lg:w-[250px] w-full relative">
                    <select
                      className="w-full lg:w-[250px] md:h-12 h-8 p-2 pl-4  pr-10 placeholder:md:text-[16px]  placeholder:text-[12px] rounded-full  placeholder:text-white text-white bg-[#5271FF] border-[#453565]"
                      required
                      name="role"
                      value={role}
                    ...
                    >
                      ...
                      <option value="Eseva">E-Seva Center</option>
                      <option value="SubAdmin">E-Seva Sub-Admin</option>
              ...
              <div className="mx-auto mt-8 flex justify-center text-[14px] md:text-[16px] items-center container font-bold font-poppins text-[#243460] ">
                <p>
                  ...
                  <span className="font-poppins font-bold text-[14px] md:text-[16px] text-[#ff5e00] ">
                    <Link href={"/e-seva/register"}>Register</Link>
                  </span>
                </p>
              </div>
      ...
      <div className="block md:hidden font-poppins  justify-between px-2 lg:pb-0 md:pb-0">
        <div className="justify-center font-poppins text-center ">
          <h1 className="md:text-[25px] text-xl text-[#5271FF] font-extrabold">
            <span className="shadow-inherit">Aarogya Aadhar</span>
          </h1>
...
export default EsevaLoginClient;
