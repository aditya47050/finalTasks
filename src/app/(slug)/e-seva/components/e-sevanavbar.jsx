...
import DashboardSidebar from "./e-sevasidebar";

const DashboardNavBar = ({ userdata, role }) => {
  ...
  return (
    <>
      ...
      >
        <div className=" md:mx-auto px-2 md:px-2  my-1 w-full xl:px-8 flex pt-1 lg:pt-0 max-w-screen-2xl xl:max-w-screen-5xl items-center justify-between">
          ...
          <div className="lg:hidden block">
            <DashboardSidebar data={userdata} role={role} />
          </div>
                ...
                <div className="text-right space-y-0">
                  ...
                  <div className="flex items-center justify-end space-x-1">
                    ...
                    <p className="text-[#ff5e00] lg:text-white text-[8px] md:text-[10px] font-medium">
                      {userdata.address ? userdata.address : "Location unavailable"}
                    </p>
                  </div>
                </div>
