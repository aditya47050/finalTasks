...
const Dashboardclient = () => {
  return (
    <>
      {" "}
      <div className="md:mt-7 lg:mb-20  md:pb-0  container space-y-2 h-auto xl:h-[540px] rounded-xl">
...
{item.link ? (
  <>
    <Link href={item.link}>
      <span className="xl:h-24 xl:w-24 p-2 h-20 w-20 bg-[#243460] rounded-2xl hover:border-2 inline-block">
        <Image
          src={item.img}
          width={200}
          height={200}
...
const dashboardicons = [
  ...
  },
  {
    ...
    link: "/ambulance/dashboard/bookambulance",
  },
  {
  ...
  },
  {
   ...
   {img: "https://res.cloudinary.com/dnckhli5u/image/upload/v1725343058/aarogya%20aadhar/SiteImages/Dashboard/lmhxfdqozjotifg0sync.png",
    ...
    link: "/ambulance/dashboard/documents"
  },
  {
    img: "https://res.cloudinary.com/dnckhli5u/image/upload/v1725343058/aarogya%20aadhar/SiteImages/Dashboard/wxwninf7d2dsel0mbpkh.png",
    title: "Network Hospital’s",
    link: "/ambulance/dashboard/hospitals",
  },
  ...
  {
    link:"/ambulance/dashboard/ads-section",
