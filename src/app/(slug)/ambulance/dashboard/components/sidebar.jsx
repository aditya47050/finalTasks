...
const DashboardSidebar = ({ firstName, city, passportPhoto, role }) => {
  ...
  const navItems = [
    {
      ...
      roles: ["Ambulance"], // Specify roles that can access this item
    },
    {
      label: "Owner Profile",
      path: `/ambulance/dashboard/profile`,
      icon: <TbUserFilled className="h-5 w-5" />,
      roles: ["Ambulance"],
    },
    {
      label: "Bookings",
      path: `/ambulance/dashboard/bookambulance`,
      icon: <FaFileAlt className="h-5 w-5" />,
      roles: ["Ambulance"],
    },
    {
      label: "Bookings",
      path: `/ambulance/driver/bookings`,
      icon: <FaFileAlt className="h-5 w-5" />,
      roles: ["Ambulance-driver"],
    },
    {
      label: "Overview",
      path: `/ambulance/dashboard/bookambulance/overview`,
      icon: <FaChartBar className="h-5 w-5" />,
      roles: ["Ambulance"],
    },
    {
      label: "Ambulances",
      path: `/ambulance/dashboard/ambulances`,
      icon: <FaAmbulance className="h-5 w-5" />,
      roles: ["Ambulance"],
    },
    {
      label: "Ambulances",
      path: `/ambulance/driver/ambulances`,
      icon: <FaAmbulance className="h-5 w-5" />,
      roles: ["Ambulance-driver"],
    },
    {
      label: "Ambulance-drivers",
      path: `/ambulance/dashboard/drivers`,
      icon: <FaUsers className="h-5 w-5" />,
      roles: ["Ambulance"],
    },
    {
      label: "HSP Certificate",
      path: `/ambulance/dashboard/certificate`,
    ...
    },
    {
      ...
      path: `/ambulance/dashboard/changepassword`,
  ...
  const getButtonClasses = (currentPath) => {
    const isActive = pathname === currentPath;
    return `flex items-center space-x-2 w-full py-2 rounded-xl ${
      isActive
  ...
  return (
    <>
            ...
            >
              ...
              <div className="flex pl-2 space-x-2 w-full">
                ...
                <div className="text-start">
                  ...
                  <div className="text-sm text-[#272727]">{city}</div>
                </div>
              </div>
              <hr className="my-2" />
      ...
      <div className="lg:block hidden">
        ...
        >
          {!isCollapsed && (
            <div className="flex  flex-col items-start pl-2 space-x-2 w-full">
              {firstName ? (
                <div className="w-12 h-12 relative">
                  {passportPhoto ? (
                    <Image
