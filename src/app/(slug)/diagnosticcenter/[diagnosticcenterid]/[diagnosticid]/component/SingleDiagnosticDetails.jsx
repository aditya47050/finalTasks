...
{/* =================== DIAGNOSTIC CENTER HEADER (Exact Screenshot + Exact Layout) =================== */}
<div
...
>
  ...
  <div className="flex flex-col justify-center gap-[2px]">
    ...
    <div className="flex items-center gap-2 text-[#243460] text-[15px] leading-none">
      ...
      {diagnosticcenterdata?.hspdetails?.category || "Diagnostic Center"}
    </div>
  </div>
...
{/* --- CARD 1: ABOUT DIAGNOSTIC CENTER --- */}
<Card
...
{/* --- CARD 2: CENTER STATUS (Exact Figma Design) --- */}
<Card
...
>
  <CardContent className="p-5">
    ...
    <div className="text-sm flex flex-wrap gap-2">
      ...
      <span style={{ color: "#E68B67" }}>
        {getYear(diagnosticcenterdata?.hspdetails?.hspregdate)}
      </span>
      ...
      <span
        style={{
          color:
            diagnosticcenterdata?.approvalStatus === "APPROVED"
    ...
    {diagnosticcenterdata?.hspdetails?.nabhnablapproved === "Yes" && (
      <p className="mt-2 text-sm flex items-center gap-1" style={{ color: "#407BFF" }}>
        ...
        NABL Accredited –{" "}
        <span style={{ color: "#E68B67" }}>
          {diagnosticcenterdata?.hspdetails?.nabhnabllevel}
        </span>
      </p>
    )}
  </CardContent>
      ...
      {[
        {
          icon: "/icons/test.png",
          title: "Total Tests",
          value: diagnosticcenterdata?.diagnosticServices?.length || "N/A",
          rows: [
        ...
        },
        {
          ...
          value: "24/7",
          rows: [
            { color: "bg-green-500", text: "24/7 Service" },
            { color: "bg-blue-500", text: "Quick Response" },
          ]
        },
        {
        ...
        },
        {
          ...
          title: "Experience",
          value: diagnosticcenterdata?.hspInfo?.experience ? `${diagnosticcenterdata.hspInfo.experience}+ Years` : "N/A",
          rows: [
        ...
        >
          ...
          <div className="flex gap-4 items-center">
            ...
            <div className="w-15 h-15 flex items-center justify-center">
              {item.icon.includes("test") && <TestTube className="w-12 h-12 text-[#243460]" />}
              {item.icon.includes("clock") && <Clock className="w-12 h-12 text-[#243460]" />}
              {item.icon.includes("award") && <Award className="w-12 h-12 text-[#243460]" />}
              {item.icon.includes("experience") && <Users className="w-12 h-12 text-[#243460]" />}
            </div>
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="text-[15px] font-semibold text-[#243460] mt-1">
          {safeDisplay(diagnosticcenterdata?.hspcontact?.receptioncontact1 || diagnosticcenterdata?.mobile, "N/A")}
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-[15px] font-semibold text-[#243460] mt-1 truncate">
          {safeDisplay(diagnosticcenterdata?.hspcontact?.receptionemail || diagnosticcenterdata?.email, "N/A")}
        </p>
      </div>
...
<div className="bg-white border border-[#00000033] rounded-2xl p-5 shadow-sm">
  ...
  <div className="flex gap-4">
    ...
    <div className="flex-1">
      ...
      <p className="text-sm text-gray-600 mt-1">
        {safeDisplay(displayCity, "City")}, {safeDisplay(displayState, "State")} {diagnosticcenterdata?.hspcontact?.pincode || diagnosticcenterdata?.pincode ? `- ${diagnosticcenterdata.hspcontact.pincode || diagnosticcenterdata.pincode}` : ""}
      </p>

      <p className="text-[15px] text-[#243460] font-medium mt-1 leading-5">
        {safeDisplay(displayAddress, "Address not available")}
      </p>
    </div>
  ...
  {/* ---------------------- NEARBY TRANSPORT ---------------------- */}
  {diagnosticcenterdata?.facilitiesJson?.transportation?.length > 0 && (
    <div className="mt-5">
      ...
      <div className="space-y-3">
        {diagnosticcenterdata.facilitiesJson.transportation.map((item, i) => (
  ...
  {/* ---------------------- NEARBY LANDMARKS ---------------------- */}
  {diagnosticcenterdata?.facilitiesJson?.landmarks?.length > 0 && (
    <div className="mt-6">
      <h3 className="text-[16px] font-semibold text-[#C47C52] mb-2">
        Nearby Landmarks
      </h3>
      ...
      <div className="space-y-3">
        {diagnosticcenterdata.facilitiesJson.landmarks.map((place, i) => (
          <div key={i} className="flex justify-between items-center">
    ...
    <CardContent className="p-0">
      ...
      <div className="p-6 bg-white">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          {[
            { icon: <TestTube className="w-5 h-5 text-[#243460]" />, label: "Diagnostic Tests", value: diagnosticcenterdata?.diagnosticServices?.length || "—", clickable: true, action: "tests" },
            { icon: <Award className="w-5 h-5 text-[#243460]" />, label: "NABL Certified", value: "Certified", clickable: true, action: "nabl" },
            { icon: <Clock className="w-5 h-5 text-[#243460]" />, label: "Service Hours", value: "24/7", clickable: true, action: "serviceHours" },
            { icon: <Shield className="w-5 h-5 text-[#243460]" />, label: "Diagnostic Services", value: "Advanced", clickable: true, action: "services" },
            { icon: <Building2 className="w-5 h-5 text-[#243460]" />, label: "Govt Schemes", value: "Available", clickable: true, action: "govtSchemes" },
            { icon: <Stethoscope className="w-5 h-5 text-[#243460]" />, label: "Pathology", value: "NABL", clickable: true, action: "pathology" },
            ...
            { icon: <Users className="w-5 h-5 text-[#243460]" />, label: "Experience", value: diagnosticcenterdata?.hspInfo?.experience ? `${diagnosticcenterdata.hspInfo.experience}+ Years` : "10+", clickable: true, action: "experience" },
            { icon: <CreditCard className="w-5 h-5 text-[#243460]" />, label: "Cashless Services", value: "Available", clickable: true, action: "cashless" },
            { icon: <User className="w-5 h-5 text-[#243460]" />, label: "Home Collection", value: "Available", clickable: true, action: "homeCollection" },
            ...(diagnosticcenterdata?.hspdetails?.nabhnablapproved === "Yes"
              ? [{
                  icon: <Award className="w-5 h-5 text-[#243460]" />,
                  label: "NABL Accredited",
                  value: diagnosticcenterdata.hspdetails.nabhnabllevel,
                  clickable: true,
                  action: "nabl",
                }]
              : []),
            { icon: <Building2 className="w-5 h-5 text-[#243460]" />, label: "Inhouse Canteen", value: "Available", clickable: true, action: "canteen" },
            { icon: <Star className="w-5 h-5 text-[#243460]" />, label: "Reviews", value: `${avgRating} ★`, clickable: true, action: "reviews" },
            ...
            <div
              ...
              onClick={
                item.clickable
                  ? () => {
                      if (item.action === "tests") setTestsDialogOpen(true);
                      else if (item.action === "serviceHours") setServiceHoursDialogOpen(true);
                      else if (item.action === "nabl") setNablDialogOpen(true);
                      else if (item.action === "services") setServicesDialogOpen(true);
                      else if (item.action === "govtSchemes") setGovtSchemesDialogOpen(true);
                      else if (item.action === "pathology") setPathologyDialogOpen(true);
                      else if (item.action === "onlineConsultation") setOnlineConsultationDialogOpen(true);
                      else if (item.action === "experience") setExperienceDialogOpen(true);
                      else if (item.action === "cashless") setCashlessDialogOpen(true);
                      else if (item.action === "homeCollection") setHomeCollectionDialogOpen(true);
                      else if (item.action === "canteen") setCanteenDialogOpen(true);
                      else if (item.action === "reviews") setReviewsDialogOpen(true);
                    }
                  : undefined
              }
