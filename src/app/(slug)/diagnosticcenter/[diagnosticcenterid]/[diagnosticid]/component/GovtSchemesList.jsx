...
import { Building2, Info, FileText, X } from "lucide-react";
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto p-0">
        <DialogHeader className="sticky top-0 z-10 bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-4 sm:p-6 rounded-t-lg">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-purple-100 text-sm mt-1">
                  Available healthcare schemes at {centerName}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="p-4 sm:p-6">
          {govtSchemesData && govtSchemesData.trim() !== "" ? (
            <Card className="border border-purple-100 shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <p>
                        ...
                        documents with the center before availing services.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="mt-6 p-4 bg-amber-50 rounded-lg border border-amber-200 max-w-lg">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-amber-800">
                        ...
                        available government healthcare schemes.
                      </p>
                    </div>
                  </div>
                </div>
