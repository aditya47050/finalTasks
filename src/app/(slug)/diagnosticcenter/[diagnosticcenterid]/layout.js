...
export const metadata = {
  ...
  keywords: "Diagnostic Center, Health, Medical, Diagnostics",
  description:
    "   Find the best diagnostic centers near you with Aarogya-Aadhar. Explore our comprehensive list of diagnostic centers and book your appointments online.",
};
 ...
 const session = await getSession();
  ...
  return (
    <>
      ...
      <div className="pt-[95px] lg:pt-[100px] lg:ml-12">{children}</div>
    </>
  );
}
