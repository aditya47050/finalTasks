                    ...
                    <div className="w-full relative">
                      ...
                      <div className="relative">
                        ...
                        <button
                          ...
                          className="absolute right-2 text-[#243460] text-[12px] md:text-[14px] font-poppins bg-white rounded-full px-2 py-1 lg:py-[7px] top-1/2 transform -translate-y-1/2"
                        >
                          {isLoading && !isOtpSent
                            ? "Sending..."
                            : isOtpSent
        ...
        if (/^\d{0,6}$/.test(inputValue)) {
          setOtp(inputValue);
                        ...
                        <button
                          ...
                          className="absolute right-2 text-[#243460] text-[12px] md:text-[14px] bg-white font-poppins rounded-full px-2 py-[7px] lg:py-[] top-1/2 transform -translate-y-1/2"
                        >
      ...
      setMobile(value);
                    ...
                    <div className="w-full relative md:mt-0 mt-2">
                      ...
                      <div className="relative">
                        ...
                        <button
                          type="button"
                          className="absolute right-2 top-1/2 transform -translate-y-1/2 text-[#243460] text-[12px] md:text-[14px] bg-white rounded-full px-2 py-1 lg:py-[7px] z-10" // Added z-10 for layering
                          onClick={() =>
