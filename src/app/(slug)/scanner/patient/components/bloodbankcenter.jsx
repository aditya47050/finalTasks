...
export default function BloodBankCenter({ bookings }) {
    ...
    return (
        <div className="container mx-auto font-poppins p-4 lg:p-6">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100">
                ...
                <div className="p-6 border-b border-gray-100">
                    <div className="text-center mb-1">
                        <h2 className="text-2xl font-bold text-blue-600 flex items-center justify-center gap-2">
                            Patient's BloodBank Service Bookings
                        </h2>
                        <p className="text-blue-600 mt-0.5">View All bloodbank bookings Done By Patient's Till Date.</p>
                    </div>
                ...
                <div className="p-4">
                    {filteredData.length ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                            {paginatedData.map((matchingServices, index) => (
                                        ...
                                        <div className="h-full flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                                            ...
                                            <div className="p-3 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <h3 className="font-semibold text-gray-900 text-xs truncate group-hover:text-blue-600 transition-colors">
                                                                {matchingServices?.service.bloodname}
                                                            </h3>
                                                    ...
                                                    <span
                                                        className={`inline-flex items-center px-2 py-0.5 rounded-full font-medium ${statusColors[matchingServices.status] || "bg-gray-100 text-gray-800"}`}
                                                    >
                                            ...
                                            <div className="p-3 flex-1 flex flex-col gap-2">
                                                ...
                                                <div className="flex items-center gap-2 p-1 rounded-lg group-hover:bg-gray-50 transition-colors">
                                                    ...
                                                    <div className="min-w-0">
                                                        ...
                                                        <p className="text-gray-600">
                                                            ₹<span className="line-through">{matchingServices?.service.price || 0}</span> → ₹{matchingServices?.service.finalprice || 0}
                                                    ...
                                                    <div className="flex items-start  gap-2 p-1 rounded-lg group-hover:bg-gray-50 transition-colors">
                                                        ...
                                                        <div className="min-w-0">
                                                            ...
                                                            <p className="text-gray-600 whitespace-nowrap">
                                                                {formatDate(matchingServices.bookingDate)}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    {/* Preferred Date */}
                                                ...
                                                {matchingServices.hospitalId && (
                                                    <div className="mt-2 p-1">
                                                        <Link
                                                            href={`/pathology/${matchingServices.serviceId}/${matchingServices.hospitalId}`}
                        ...
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-sm font-medium text-gray-900 mb-1.5">
                                No Blood Booking Found In Any Center
                            </h3>
                ...
                {pageCount > 1 && (
                    <div className="px-6 py-2 border-t border-gray-100 bg-gray-50 rounded-b-2xl mt-4">
                        <div className="flex items-center justify-between">
                            <Button
