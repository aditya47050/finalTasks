...
// ✅ Extract unique categories & services (only Surgery type)
...
const serviceOptions = categories.flatMap((cat) =>
  cat.Services.filter((srv) => srv.Type === "Surgery").map((srv) => ({
    value: srv.Name,
    label: srv.Name,
  }))
);
...
const SurgerySchedule = ({ userdata }) => {
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="text-center mb-1">
            <h2 className="text-2xl font-bold text-blue-600 flex items-center justify-center gap-2">
              Patient's Surgery Bookings
            </h2>
            <p className="text-blue-600 mt-0.5">View  Surgery Bookings Done By Patient's Till Date.</p>
          </div>
          ...
          {/* Filters */}
          {showFilters && (
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-2 p-3 bg-gray-50 rounded-xl border border-gray-200">
              <SelectField
                label="Category"
                id="category"
        ...
        <div className="p-6">
          {paginatedData.length ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-1.5">No surgery bookings found</h3>
