...
const CorporateRegisterClient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const registerRes = await fetch("/api/corporate/register", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      router.push("/corporate/login"); // Redirect to login
    } catch (error) {
...
export default CorporateRegisterClient;
