...
import { Search, FileText, Filter, Download, Eye, CheckCircle, XCircle, Clock, ZoomIn, ZoomOut, Building, Stethoscope, Home, Microscope } from "lucide-react";
import HospitalCertificate from "./hospitalcertificate"; 
...
const roleIcons = {
  ...
  DiagnosticCenter: Microscope
};

const roleColors = {
  Hospital: "bg-blue-100 text-blue-800 border-blue-200",
  Clinic: "bg-green-100 text-green-800 border-green-200",
  homehealthcare: "bg-purple-100 text-purple-800 border-purple-200",
  Pathology: "bg-orange-100 text-orange-800 border-orange-200",
  DiagnosticCenter: "bg-cyan-100 text-cyan-800 border-cyan-200"
};

export default function HospitalDocumentsView({ hospital, documents, documentsByCategory }) {
  ...
  const viewDocument = (doc) => {
    console.log("Viewing document:", {
      ...
      certificateData: doc.certificateData
    });
  ...
  const RoleIcon = roleIcons[hospital.role] || Building;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-100 p-4">
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div>
              <h1 className="text-4xl font-bold text-gray-900 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                {hospital.role} Documents
              </h1>
              <p className="text-lg text-gray-600">
                Manage all your {hospital.role.toLowerCase()} documents and certificates
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center">
          <Badge className={`${roleColors[hospital.role]} px-4 py-2 text-lg font-semibold`}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="aspect-video bg-gray-100 rounded-lg border border-gray-200 overflow-hidden flex items-center justify-center">
                    {doc.category === "Certificates" ? (
                      // 🔹 FIX: Pass the data in the SAME structure as DigitalHealthCardPage
                      <div className="w-full h-full transform scale-75 origin-center">
                        <HospitalCertificate data={doc.certificateData || hospital} />
                      </div>
                    ) : doc.url ? (
          ...
          <div className="bg-white rounded-lg max-w-6xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="p-4 max-h-[calc(90vh-80px)] overflow-auto flex items-center justify-center">
              {currentDocument.category === "Certificates" ? (
                ...
                >
                  <HospitalCertificate data={currentDocument.certificateData || hospital} />
                </div>
              ) : currentDocument.url ? (
                // Regular document image
                <img 
