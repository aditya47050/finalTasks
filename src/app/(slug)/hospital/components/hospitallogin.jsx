...
const HospitalLogin = () => {
  ...
  const roleFromParam = searchParams.get("role") || "Hospital";
  ...
  const handleSendOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const res = await fetch("/api/otps/hospital-login/send-otp", {
        method: "POST",
        headers: {
  ...
  const handleVerifyOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const verifyRes = await fetch("/api/otps/hospital-login/verify-otp", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("/api/hospital/login", {
        ...
        body: JSON.stringify({ email, password, mobile ,role: roleFromParam }), // Include role in the request body
      });
  ...
  return (
    <>
      {" "}
      <div className="hidden md:block font-poppins  justify-between lg:pb-0 md:pb-0 mt-1 md:mt-0">
  ...
  <div className="relative mt-1">
    ...
    <Link href={"/hospital/authforgot"}>
              ...
              <div className="mx-auto mt-8 flex justify-center text-[14px] md:text-[16px] items-center container font-bold font-poppins text-[#243460] ">
                <p>
                  ...
                  <span className="font-poppins font-bold text-[14px] md:text-[16px] text-[#ff5e00] ">
                    <Link href={"/hospital/register"}>Register</Link>
                  </span>
                </p>
              </div>
      ...
      <div className="block md:hidden font-poppins  justify-between px-2 lg:pb-0 md:pb-0 mt-1 md:mt-0">
        <div className="justify-center font-poppins text-center ">
          <h1 className="md:text-[25px] text-xl text-[#5271FF] font-extrabold">
            <span className="shadow-inherit">Aarogya Aadhar</span>
          </h1>
