...
const TeleRadiologyLoginClient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // }
    try {
      const res = await fetch("/api/teleradiology/login", {
        method: "POST",
        headers: {
      ...
      toast("Login Success");
      router.push("/teleradiology/dashboard");
    } catch (error) {
  ...
  return (
    <>
      {" "}
      <div className="mt-10 font-poppins  justify-between ">
        ...
        <form onSubmit={handleSubmit}>
          <div className="w-full  mx-auto container flex gap-4 mb-2">
            ...
            <div className="w-full">
              <div className="mx-auto md:container w-full  lg:px-64 rounded-xl">
                      ...
                      <div className="relative">
                        <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white">
                         ...
                         <input
                          ...
                          className="w-full md:h-12 h-10 pl-10 pr-20 md:pr-28 placeholder:md:text-[16px] md:text-[16px] text-[12px] placeholder:text-[12px] p-2 placeholder:text-white text-white bg-[#5271FF] rounded-full border-[#453565]"
        ...
        if (/^\d{0,6}$/.test(inputValue)) {
          setOtp(inputValue);
                          ...
                          className="w-full md:h-12 h-10 pl-4 pr-10 md:pr-28 placeholder:md:text-[16px] md:text-[16px] text-[12px] placeholder:text-[12px] p-2 placeholder:text-white text-white bg-[#5271FF] rounded-full border-[#453565]"
                ...
                <div className="space-y-4 mt-0 md:mt-8">
        ...
        setMobile(value);
                    ...
                    <div className="w-full relative md:mt-0 mt-2">
                      ...
                      <div className="relative">
                        ...
                        <button
                          type="button"
                          className="absolute right-3 top-1/2 transform -translate-y-1/2 text-white text-[16px] z-10" // Added z-10 for layering
                          onClick={() =>
              ...
              <div className="mx-auto mt-4 flex justify-center text-[14px] md:text-[16px] items-center container font-bold font-poppins text-[#243460] ">
                <p>
                  ...
                  <span className="font-poppins font-bold text-[14px] md:text-[16px] text-[#ff5e00] ">
                    <Link href={"/teleradiology/register"}>Register</Link>
                  </span>
                </p>
              </div>
...
export default TeleRadiologyLoginClient;
