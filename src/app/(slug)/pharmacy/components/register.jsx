...
const PharmacyRegister = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const verifyRes = await fetch("/api/pharmacy/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const registerRes = await fetch("/api/pharmacy/register", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          mobile,
      ...
      if (!registerRes.ok) throw new Error("Failed to create an account");
  ...
  return (
    ...
    <div className="hidden md:block">
      <div className="mt-1 justify-between font-poppins md:pb-0">
        ...
        <div className="mx-auto mt-4 flex justify-center text-[14px] md:text-[16px] items-center container font-bold font-poppins text-[#243460] ">
          <p>
            ...
            <span className="font-poppins font-bold text-[14px] md:text-[16px] text-[#ff5e00] ">
              <Link href={"/pharmacy/login"}>Login</Link>
            </span>
          </p>
        </div>
      </div>
    ...
    <div className="block md:hidden">
      <div className="px-2 justify-between font-poppins md:pb-0">
        <div className="justify-center text-center ">
          <h1 className="md:text-[25px] text-xl text-[#5271FF] font-extrabold">
            <span className="shadow-inherit">Aarogya Aadhar</span>
          </h1>
