...
import { Search, FileText, Filter, Download, Eye, CheckCircle, XCircle, Clock, ZoomIn, ZoomOut, Building, User, Store } from "lucide-react";
import PharmacyCertificate from "./pharmacycertificate"; 
...
const categoryColors = {
  ...
  Branding: "bg-purple-100 text-purple-800 border-purple-200",
  Pharmacist: "bg-orange-100 text-orange-800 border-orange-200",
  Branches: "bg-cyan-100 text-cyan-800 border-cyan-200",
  Certificates: "bg-red-100 text-red-800 border-red-200"
};

export default function PharmacyDocumentsView({ pharmacy, documents, documentsByCategory }) {
  ...
  const viewDocument = (doc) => {
    console.log("Viewing pharmacy document:", {
      docId: doc.id,
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600">
                Manage all your pharmacy documents and certificates
              </p>
            </div>
          </div>
        </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="aspect-video bg-gray-100 rounded-lg border border-gray-200 overflow-hidden flex items-center justify-center">
                    {doc.category === "Certificates" ? (
                      // Render actual PharmacyCertificate component
                      <div className="w-full h-full transform scale-75 origin-center">
                        <PharmacyCertificate data={doc.certificateData || pharmacy} />
                      </div>
                    ) : doc.url ? (
          ...
          <div className="bg-white rounded-lg max-w-6xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="p-4 max-h-[calc(90vh-80px)] overflow-auto flex items-center justify-center">
              {currentDocument.category === "Certificates" ? (
                ...
                >
                  <PharmacyCertificate data={currentDocument.certificateData || pharmacy} />
                </div>
              ) : currentDocument.url ? (
                // Regular document image
                <img 
