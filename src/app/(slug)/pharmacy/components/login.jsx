...
const Pharmacylogin = () => {
  ...
  const handleSendOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const res = await fetch("/api/otps/pharmacy-login/send-otp", {
        method: "POST",
        headers: {
  ...
  const handleVerifyOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const verifyRes = await fetch("/api/otps/pharmacy-login/verify-otp", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data = { msg: "Server did not return JSON" };
    }
