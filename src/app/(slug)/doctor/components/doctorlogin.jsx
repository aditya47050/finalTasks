...
const DoctorLogin = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const verifyRes = await fetch("/api/otps/doctor-login/verify-otp", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    <>
      {" "}
      <div className="hidden md:block font-poppins  justify-between lg:pb-0 md:pb-0 mt-2 md:mt-0">
