                    ...
                    <div className="w-full relative">
                      <h1 className="text-[#453565] font-semibold text-[14px] md:text-[16px] ml-4 font-poppins">
                        ...
                        <input
                          ...
                          className="w-full md:h-12 h-8 pl-10 pr-10 md:pr-28 placeholder:md:text-[16px] md:text-[16px] text-[12px] placeholder:text-[12px] p-2 placeholder:text-white text-white bg-[#5271FF] rounded-full border-[#453565]"
