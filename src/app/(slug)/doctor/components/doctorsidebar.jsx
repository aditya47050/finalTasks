...
const DashboardSidebar = ({ data }) => {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("/doctor/login"); // Redirect to homepage after logout
      } else {
  ...
  const navItems = [
    ...
    {
      label: "Certificate",
      path: `/doctor/dashboard/certificate`,
      icon: <IdCard className="h-5 w-5" />,
    },
    // {
    //   label: "Update Documents",
    //   path: `/doctor/dashboard/update-documents`,
            ...
            >
              ...
              <div className="flex pl-2 space-x-2 w-full">
                ...
                <div className="text-start">
                  ...
                  <div className="text-sm text-[#272727]">{data.doctorinfo.city}</div>
                </div>
              </div>
              <hr className="my-2" />
            ...
            <div className="flex items-start pl-2 space-x-2 w-full">
              {data.firstName ? (
                <div className="w-12 h-12 relative">
                  {data.doctorinfo.passportphoto ? (
                    <Image
                      src={data.doctorinfo.passportphoto}
                      alt="Profile Image"
                      layout="fill"
                      className="rounded-full object-cover"
                    />
