...
const DoctorLoginPage = async () => {
  ...
  if (!loggedemail) {
    return (
      <>
        ...
        <div className="pt-[95px] xs:pt-[120px] md:pt-[160px] xlg:pl-12 lg:ml-12 xl:ml-0">
          <DoctorLogin />
        </div>
      </>
    );
  ...
  return (
    <>
      <div className="">
<NavBar hspcategory={hspcategory} doctorcategory={doctortype} userData={userData} />        <Mobilenav data={userData} />
      </div>
      <div className="hidden lg:block">
        <MainSidebar />
      </div>
