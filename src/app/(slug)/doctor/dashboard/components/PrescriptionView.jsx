...
export default function PrescriptionView({ prescription }) {
  ...
  const handleDownload = () => console.log("Download prescription as PDF")
...
<div className="p-6 space-y-2">
  ...
  <div className="grid grid-cols-2 border border-gray-800">
    <div className="bg-blue-100 p-3 border-r border-gray-800">
  ...
  <div className="grid grid-cols-4 border-l border-r border-gray-800">
    {[
  ...
  <div className="grid grid-cols-2 border-l border-r border-gray-800">
  ...
  <div className="border border-gray-800">
    <div className="grid grid-cols-3 bg-blue-100 border-b border-gray-800">
      ...
      <div className="p-3 font-semibold text-center">Dosage (Per Day)</div>
    </div>
    {prescription.medications.map((med, idx) => (
      <div key={idx} className={`grid grid-cols-3 ${idx % 2 === 0 ? "bg-yellow-100" : "bg-blue-100"} border-b border-gray-800`}>
        <div className="p-3 border-r border-gray-800">{idx + 1}. {med.name}</div>
        <div className="p-3 border-r border-gray-800">{med.unit}</div>
        <div className="p-3">{med.dosage}</div>
      </div>
    ))}
    {/* Extra empty rows */}
    {[...Array(3)].map((_, i) => (
      <div key={`extra-${i}`} className={`grid grid-cols-3 ${i % 2 === 0 ? "bg-yellow-50" : "bg-blue-50"} border-b border-gray-800`}>
