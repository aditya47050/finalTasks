...
const avgRating =
  ...
  const doctorCertificate = data?.data?.DoctorCertificate?.[0]; // first certificate
const createdAtRaw = doctorCertificate?.createdAt;
const regno = data?.data?.DoctorCertificate?.[0].cardNo;
...
if (createdAtRaw) {
  ...
  const doctorName = data?.data?.firstName && data?.data?.lastName
    ? `${data?.data.firstName} ${data?.data.lastName}`
    : data?.data?.firstName || data?.data?.lastName || "Doctor Name";
