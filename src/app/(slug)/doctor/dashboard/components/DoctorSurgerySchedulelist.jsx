...
const DoctorSurgerySchedulelist = ({ bookings }) => {
  ...
  const exportToExcel = () => {
    const csvContent = [
      ["Patient Name", "Mobile", "Surgery Type", "Category", "Date", "Time", "Status", "Hospital", "Doctor"],
    ...
    a.href = url
    a.download = `surgery-schedule-${format(new Date(), "yyyy-MM-dd")}.csv`
    a.click()
        ...
        <div className="text-center space-y-4 animate-fade-in">
          <div className="flex flex-col items-center justify-center gap-3 mb-4">
            <div>
              ...
              <h1 className="text-[24px] text-[#2b73ec] font-extrabold inline-block">Surgery Schedule Management</h1>
            </div>
              <p className="text-[#243460] text-[13px] mt-1">
                Hospital-Assigned Surgery Bookings & Patient Care Coordination
              </p>
          </div>
        </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="flex items-center gap-2 p-2 bg-green-50 rounded-lg">
                      ...
                      <div>
                        <p className="text-xs text-gray-500">Surgery Date</p>
        ...
        {filteredBookings.length === 0 && (
          <Card className="text-center py-12 bg-white/80 backdrop-blur-sm border-0 shadow-lg">
            <CardContent>
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No Surgery Bookings Found</h3>
              <p className="text-gray-600">
                {searchTerm || statusFilter !== "all" || dateFilter || categoryFilter !== "all"
                  ? "Try adjusting your filters to see more results."
                  : "No surgery bookings have been assigned yet."}
              </p>
            </CardContent>
          </Card>
        )}
...
export default DoctorSurgerySchedulelist
