...
const DashboardSidebar = ({ userdata }) => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      path: `/patient/dashboard/updateprofile`,
      icon: <MdEditDocument className="h-5 w-5" />,
    },
    {
      label: "Family Details",
      path: `/patient/dashboard/family-details`,
      icon: <MdFamilyRestroom className="h-5 w-5" />,
    },

    {
      label: "Document Importance",
      path: `/patient/dashboard/doc-importance`,
    ...
    },
    {
      ...
      submenu: [
        {
          label: "Personal & Medical Data Consent",
          path: `/patient/dashboard/terms-conditions`,
          icon: <FaBookMedical className="h-4 w-4" />,
        },
        {
          label: "Terms & Conditions",
  ...
  const getButtonClasses = (index) =>
    `flex items-center space-x-2 w-full py-2 rounded-xl ${pathname === navItems[index].path
  ...
  return (
    <>
      ...
      <div className="lg:hidden block">
        ...
        {isOpen && (
          <div className="fixed inset-0 mt-0 bg-black bg-opacity-50 z-40">
          <div
  ref={sidebarRef}
  className="fixed top-0 left-0 w-64 h-full bg-white z-50 shadow-xl transition-transform duration-300 ease-in-out transform"
  style={{
...
>
              ...
              <div className="flex pl-2 space-x-2 w-full">
                <div className="w-12 h-12 relative">
                  <div className="relative h-12 w-12">
                    {userdata?.passportPhoto ? (
                      ...
                      <span className="flex items-center justify-center shadow-lg h-12 w-12 bg-blue-200 text-black rounded-full font-semibold">
                ...
                <div className="text-start">
                  ...
                  <div className="text-sm text-[#272727]">{userdata.city}</div>
                </div>
              </div>
              <hr className="my-1" />
                ...
                {navItems.map((item, index) => (
                  <div key={index}>
                    ...
                    >
                      <div className="pl-4 flex items-center justify-between mr-4 w-full">
                        <div className="flex items-center space-x-3">
                          <span
                            className={`${pathname === navItems[index].path
                    ...
                    {item.submenu && submenuStates[index] && (
                      <div className="ml-8 mt-1 flex flex-col space-y-1 bg-white">
      ...
      <div className="lg:block hidden">
        <div
          className={`bg-[#fff] fixed pt-20 min-h-screen  left-0 h-full overflow-scroll shadow-xl flex flex-col space-y-2 transition-all duration-300 ${isCollapsed ? "w-[5rem]" : "w-[15rem]"
            }`}
          ref={sidebarRef}
        >
          {!isCollapsed && (
