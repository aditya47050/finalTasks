...
export default function HealthInsurance({
  ...
  const InsuranceCard = ({ insurance, isPrimary = false }) => (
    <div
      className="group relative h-full flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden"
      style={{ minHeight: 220 }}
    >
      {/* Card Header */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="text-blue-700 text-xs">{insurance.provider || "N/A"}</span>
            </div>
          </div>
          {isPrimary && (
            <span className="inline-flex items-center px-2 py-0.5 rounded-full font-medium bg-blue-100 text-blue-800 text-xs">
              Primary
            </span>
          )}
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100">
        ...
        <div className="p-4 sm:p-6 border-b border-gray-100">
          <div className="text-center mb-1">
            ...
            <p className="text-blue-600 mt-0.5">Manage and view your health insurance policies</p>
          </div>
          {/* Top Actions */}
          <div className="flex flex-col sm:flex-row flex-wrap justify-end gap-2 py-4">
            <Button
