...
const PatientRegister = () => {
  ...
  // Handle ABHA Card navigation
  const handleABHACardClick = () => {
    ...
    <>
      <div className="hidden md:block mt-1 justify-between font-poppins md:pb-0">
        <div className="flex justify-between items-center mb-6 px-4">
          ...
          <button
            onClick={handleABHACardClick}
            className="bg-[#5271FF] hover:bg-[#3a5af5] text-white font-semibold py-2 px-4 rounded-full transition duration-200 shadow-sm hover:shadow-md whitespace-nowrap"
          >
            Create with ABHA Card
          </button>
        </div>
            ...
            <div className="w-full">
              <div className="mx-auto md:container w-full lg:px-40 rounded-xl">
                  ...
                  <div className="flex flex-wrap md:flex-nowrap justify-center md:space-x-4">
                    ...
                    <div className="w-full mt-2 md:mt-0">
                      ...
                      <input
                        ...
                        className="w-full md:h-12 h-8 pl-4 p-2 placeholder:md:text-[16px]  placeholder:text-[12px] border  placeholder:text-white text-white bg-[#5271FF] rounded-full"
                ...
                <div className="flex justify-center mt-8">
                  <button
                    type="submit"
                    className="bg-[#5271FF] font-semibold text-white px-8 py-2 rounded-full"
        ...
        <div className="hidden lg:block h-[1px] lg:w-4/6 px-2 mt-8 mx-auto bg-gray-200"></div>
      ...
      <div className="block md:hidden px-2 justify-between font-poppins md:pb-0">
        <div className="justify-center text-center ">
          ...
          <button
            onClick={handleABHACardClick}
            className="bg-[#5271FF] hover:bg-[#3a5af5] text-white font-semibold py-2 px-3 rounded-full transition duration-200 shadow-sm hover:shadow-md text-sm whitespace-nowrap ml-2"
          >
            Create with ABHA Card
          </button>
        </div>
          ...
          <form className="space-y-2" onSubmit={handleSubmit}>
            <div className="space-y-4 mt-4">
              <div className="grid grid-cols-1 gap-4">
                ...
                {/* ReCAPTCHA */}
                <div className="flex justify-center rounded-xl mt-8">
                  <ReCAPTCHA
                    sitekey={process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY}
                    onChange={onCaptchaChange}
                  />
