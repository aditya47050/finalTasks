...
const Healthcard = ({ userdata }) => {
  ...
  return (
    <div className="mx-auto max-w-6xl pb-40 font-poppins container my-10">
      <HeadingClientMain main={"Digital Health Card"}/>
      {/* Download Button
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:space-x-10">
          ...
          <div className="absolute inset-0 flex  text-white bg-gradient-to-t  p-4">
            <div>
              ...
              <Image
                ...
                width={800}
                alt=""
                className="lg:h-[150px] xl:h-[170px]  xs:h-[80px] xs:w-16 sm:h-[120px] xsm:h-[100px] xsm:w-20 md:h-[110px] h-28 w-20 md:rounded-[15px] rounded-[10px]  md:w-24 lg:w-32 xl:w-36  items-start justify-start md:ml-2 ml-2 mt-[25px] object-cover sm:mt-[34px] sm:w-28 lg:ml-6 md:mt-[26px] xl:mt-[60px] lg:mt-[50px]"
              />
            </div>
            <div className="flex flex-col xs:text-[8px] xsm:text-[9px] sm:text-[11px]  md:text-[10px] xs:mt-[50px] xsm:mt-[68px] sm:mt-[86px] md:mt-[70px] xl:mt-[120px] lg:mt-[110px] ml-4">
              <div className="flex xl:mb-3 mb-2">
                <h2 className="lg:text-[14px] font-poppins font-semibold text-white mr-2">
                  Name:
                </h2>
                <p className="lg:text-[14px] font-poppins text-white">
                  {userdata.firstName} {userdata.lastName}
                </p>
              </div>
              ...
              <div className="flex xl:mt-6 sm:mt-2 lg:mt-3 xsm:mt-1  md:mt-3 -ml-7">
                <h2 className="lg:text-[16px] font-poppins font-semibold text-white mr-2">
                  ABHA No:
                </h2>
        ...
        >
          ...
          <div className="absolute inset-0  text-white p-2 md:p-4">
            <div className="  md:ml-[180px] lg:ml-14 xs:ml-[152px] xsm:ml-[200px] sm:ml-[220px] xl:-ml-2 items-center justify-center flex">
              <QRCode
                value={qrCodeUrl}
                size={100} // Placeholder size, overridden by CSS
               
                className="bg-white rounded-xl p-2 h-20 w-20 sm:h-24 sm:w-24"
              />
            </div>{" "}
            <div className="flex flex-col lg:mt-[20px]  sm:mt-[36px] xsm:mt-[24px] xsm:ml-[39px] xs:ml-[32px] sm:ml-[50px]  md:ml-[25px]  lg:ml-[30px]">
              <div className="flex mb-4 flex-col">
                <h2 className="md:text-[25px] sm:text-[28px] xsm:text-[25px] xs:text-[20px] font-normal font-sans text-white mb-1">
                  Card No
                </h2>
                <p className="lg:text-[14px] sm:text-[27px] xs:text-[19px]  xsm:text-[23px] font-poppins text-white">
                  {userdata.patient.aadharCardNumber.length === 12 ? (
              ...
              <div className="md:mt-[-30px] xsm:-mt-4 xs:-ml-2 xsm:-ml-3 sm:-ml-4 md:-ml-4 ">
                <Image
                  src={
                    "https://res.cloudinary.com/dnckhli5u/image/upload/v1729696034/map_rlvat4.png"
                  }
