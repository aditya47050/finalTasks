...
const EmergencyAmbulanceClient = ({ userdata }) => {
  const pageSize = 10;
          ...
          return image ? (
            <Dialog>
              <DialogTrigger asChild>
                <Button className="bg-[#5271FF] hover:bg-blue-500 rounded-xl text-white px-3 py-1 hover:text-white">
                  View
                </Button>
              </DialogTrigger>
              <DialogContent className="flex justify-center h-[400px] items-center">
                <Image
                  src={image}
                  alt="Ambulance Large"
                  width={500}
  ...
  return (
    <div className="md:container mx-auto font-poppins">
      <div className="overflow-x-auto xs:px-2 min-[1000px]:px-0 min-[1100px]:px-[32px] container mx-auto min-[1000px]:w-[700px] min-[1100px]:w-[900px] xl:w-[1000px] xlg:w-[1200px] w-[350px] md:w-[700px] bg-white">
        <HeadingClientMain main={"Emergency Ambulance Booking"} sub={"Patient Details"} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 p-4">
          ...
          <Input
            ...
            onChange={(e) =>
              handleFilterChange("ambulancecategory", e.target.value)
            }
            className=" p-2 rounded-xl w-full"
          />{" "}
        </div>
...
export default EmergencyAmbulanceClient;
