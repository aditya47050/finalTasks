...
import HelpCenterDialog from './../aarogyadhan/components/help-center-dialog';

const CrowdFund1 = () => {
  const pathname = usePathname();
  return (
    <>
      <div className="mx-auto container  font-poppins hidden lg:block w-full  mb-4 min-[800px]:px-0 min-[1020px]:px-4  p-4 ">
     ...
     <div className="pt-2 text-sm md:text-2xl font-bold text-[#243460] ml-4">
       ...
       <h1 className="text-black">FUNDS TOO!</h1>
        ...
        {pathname === "/" && (
          <div>
            ...
            <div className="mx-auto overflow-auto container max-[1200px]:px-auto min-[1200px]:px-0">
              <Carousel
                opts={{
                  align: "start",
                }}
              ...
              >
                <CarouselContent>
                  <div className="sm:mx-10 overflow-auto md:mx-auto lg:mx-auto container mt-4 min-[900px]:pl-0">
                    <div
                      // ref={scrollRef}   style={{
      ...
      <div className="mx-auto font-poppins md:container lg:hidden block w-full  lg:pt-2 lg:px-0 px-[2rem]">
        <div className="w-full flex flex-col mt-1 md:mt-5  space-y-5 ">
          <div
            className="w-full lg:w-11/12 rounded-3xl h-auto "
            // style={{
            //   backgroundImage:
            //     "url('https://res.cloudinary.com/dnckhli5u/image/upload/v1724231101/aarogya%20aadhar/uzvxhwfjihmlduj0k9ww.png')",
