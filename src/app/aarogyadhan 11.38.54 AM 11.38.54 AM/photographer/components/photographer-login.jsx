...
const PhotoGrapherLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // }
    try {
      const res = await fetch("/api/aarogyadhan/photographer/login", {
        method: "POST",
        headers: {
      ...
      window.location.href = "/aarogyadhan/photographer/dashboard";
    } catch (error) {
      toast.error("Password is not correct.");
      router.push("/aarogyadhan/photographer/login");
    } finally {
      setIsLoading(false);
      setIsSubmitting(false);
    }
  ...
  return (
    <>
      {" "}
      <div className=" font-poppins  justify-between mt-1 lg:pb-40 md:pb-0">
                  ...
                  <div className="flex flex-wrap md:flex-nowrap justify-center md:space-x-4">
                    ...
                    <div className="w-full relative md:mt-0 mt-2">
                      ...
                      <div className="relative mt-1">
                        ...
                        <Link href={"/aarogyadhan/photographer/authforgot"}>
              ...
              <div className="mx-auto mt-8 flex justify-center text-[14px] md:text-[16px] items-center container font-bold font-poppins text-[#243460] ">
                <p>
                  ...
                  <span className="font-poppins font-bold text-[14px] md:text-[16px] text-[#ff5e00] ">
                    <Link href={"/aarogyadhan/photographer/register"}>Register</Link>
                  </span>
                </p>
              </div>
