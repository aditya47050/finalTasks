...
export default function EmployeeLogin() {
  ...
  const handleVerifyOtp = async () => {
    ...
    setIsLoading(true);
    try {
      const res = await fetch("/api/jobaadhar/employer/loginverifyotp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  try {
    const res = await fetch("/api/jobaadhar/employer/login", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    if (!res.ok) {
      ...
      if (res.status === 403 && data.msg.includes("pending")) {
        toast.warn(data.msg); // Show "Your account is pending admin approval."
      } else {
    ...
    router.push("/jobaadhar/employer/dashboard");
  } catch (error) {
        ...
        <div className="w-full mx-auto md:container flex gap-4 mb-2">
          <div className="w-full">
            <div className="mx-auto container w-full lg:px-36 xl:px-64 rounded-xl">
              ...
              <div className="mt-4 flex flex-wrap md:flex-nowrap md:space-x-4">
                <div className="w-full relative">
                  <h1 className="text-[#453565] font-semibold ml-4">Email ID*</h1>
              ...
              <div className="mt-6 flex flex-wrap md:flex-nowrap md:space-x-4">
                ...
                <div className="w-full relative">
                  ...
                  <div className="relative mt-1">
                    ...
                    <Link href="/jobaadhar/employer/authforgot">
            ...
            <div className="mx-auto mt-8 text-center font-bold text-[#243460]">
              ...
              <Link href="/jobaadhar/employer/register" className="text-[#ff5e00]">
                Register
              </Link>
            </div>
            <Mobilefooter />
