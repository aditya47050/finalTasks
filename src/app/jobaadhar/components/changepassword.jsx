...
const ChangePasswordClient = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const verifyRes = await fetch("/api/jobaadhar/job-seeker/loginverifyotp", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("/api/jobaadhar/job-seeker/changepassword", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    <div className="min-h-screen bg-white py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className=" rounded-2xl border-[1px] mt-8 p-8">
