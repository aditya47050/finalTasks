    ...
    return (
      <div className="flex flex-col items-center justify-center">
        <Card className="w-full mx-auto">
          <CardHeader>
            <CardTitle className="text-blue-500 text-center">Job Applications</CardTitle>
            <CardDescription className="text-blue-500 text-center">
              Review and manage all incoming job applications.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ApplicationList employerId={employerId} />
          </CardContent>
        </Card>
      </div>
    );
