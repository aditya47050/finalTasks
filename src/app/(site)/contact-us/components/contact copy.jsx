...
const ContactClient = () => {
  ...
  return (
    <>
      <div className=" hidden lg:flex  flex-col justify-between xs:mt-8 sm:mt-8 md:pb-0 md:mt-8 lg:mt-8 xl:mt-8 lg:mb-10 xlg:my-0 xlg:container">
        ...
        <div className=" w-full lg:w-[94%] md:mt-6 xl:mt-0  mx-auto min-[1100px]:mx-12 px-4 lg:px-6 flex-wrap md:flex-nowrap flex gap-4 mb-2">
          {/* Form Section */}
          ...
          <div className="flex flex-col justify-start gap-2 items-start lg:w-[40%] xl:w-1/2  md:pl-6 xl:px-10 xl:p-4 my-auto">
      ...
      <div className=" flex lg:hidden  flex-col justify-between xs:mt-8 sm:mt-8 md:pb-0 md:mt-8 lg:mt-8 xl:mt-8 lg:mb-10 xlg:my-0 xlg:container">
        ...
        {/* Form and Details */}
        {/* w-full  mx-auto container flex flex-wrap md:flex-nowrap gap-4 mb-2 */}
        <div className=" w-full lg:w-[94%] md:mt-6  mx-auto min-[1100px]:mx-12 px-4 lg:px-6 flex-wrap md:flex-nowrap flex gap-4 mb-2">
          {/* Form Section */}
          <form onSubmit={handleSubmit} className="md:w-4/5 w-full">
            {" "}
            <div className="">
              <div className="mx-auto container w-full border-2 bg-[#5271FF]  lg:border-[#2b73ec] shadow-lg hover:shadow-xl transition-shadow xs:p-8 lg:p-8 p-1 rounded-xl">
