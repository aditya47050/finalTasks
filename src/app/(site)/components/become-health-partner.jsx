...
const BecomeHealthPartnerClient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const registerRes = await fetch("/api/become-health-partner", {
        method: "POST",
        body: formPayload,
      });
  ...
  return (
    <>
    <div className="hidden lg:block md:mx-auto md:container my-4 px-2 md:px-0">
      <div className="justify-center font-poppins text-center ">
          <h1 className="md:text-[25px] text-xl text-[#5271FF] font-extrabold">
            <span className="shadow-inherit">AarogyaMitra</span>
          </h1>
      ...
      {/* <div className="relative w-full">
        <Image
          ...
          width={4000}
          height={844}
          className="w-full h-[80px] md:h-full md:rounded-[15px]"
          alt="Trigger Dialog"
        />
        <div className="absolute top-[20%] md:top-[80%] left-[70%] transform -translate-x-1/2 -translate-y-1/2 text-white px-2 md:px-4 md:py-2 py-1 rounded-md">
          <p>
            <button className=" bg-white rounded-full text-orange-600 px-4 py-1 shadow-lg text-[7px] md:text-[14px] font-poppins font-semibold">
              Register Now
            </button>
          </p>
        </div>
                    ...
                    >
                      ...
                      {OurServices.map((category, index) => (
                        <option
                          key={index}
                          value={category.link}
                          className="w-full sm:w-1/2 bg-white text-gray-500 text-xs md:text-sm"
                        >
                          {category.text}
                        </option>
                      ))}
            ...
            <div className="mx-auto  md:block hidden p-2 lg:px-10 xl:px-20">
                <div className="mx-auto p-4 bg-gradient-to-br from-[#5271FF] to-blue-400 rounded-xl">
                  <p className="font-poppins font-medium min-[1100px]:text-[16px] text-[14px] text-white">
                    AarogyaMitra Healthcare Education is our commitment to spreading awareness and knowledge about health, wellness, and preventive care. We believe that informed patients and families make better decisions and experience improved outcomes.<br/>
                  </p>
    ...
    <div className="block lg:hidden md:mx-auto md:container my-4 px-2 md:px-0">
      <div className="justify-center font-poppins text-center ">
          <h1 className="md:text-[25px] text-xl text-[#5271FF] font-extrabold">
            <span className="shadow-inherit">AarogyaMitra</span>
          </h1>
                ...
                <div className="w-full relative">
                  ...
                  <div className="relative mt-1">
                    <select
                      ...
                      onChange={handleChange}
                    >
                      <option value="" disabled className="w-full sm:w-1/2 bg-white text-gray-400 text-xs md:text-sm">
                        Select Option
                      </option>
                      {OurServices.map((category, index) => (
                        <option
...
export default BecomeHealthPartnerClient;
const OurServices = [
  {
