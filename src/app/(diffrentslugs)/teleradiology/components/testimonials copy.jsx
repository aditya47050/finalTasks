...
const Testimonials = () => {
  ...
  return (
    <>
      <div className="hidden md:block mx-auto md:container px-4 my-6">
                ...
                >
                  <Card className="h-full border-0 bg-gray-50 shadow-md">
                    <CardContent className="p-6 flex flex-col h-full">
                      ...
                      <div className="h-28 min-[500px]:h-20 min-[1024px]:h-28 overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100"> <p className="text-gray-700 text-sm leading-relaxed">{testimonial.description}</p> </div>
                    </CardContent>
                  </Card>
                </div>
              ))}
