...
export async function POST(request) {
  ...
  await db.EmergencyAmbulanceBookingOTP.deleteMany({
    where: { email },
  });
  await db.EmergencyAmbulanceBookingOTP.create({
    data: { email, otp },
  });
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6;">
        ...
        <p>Thank you for choosing Aarogya Aadhar <span style="color: #FF0000;">Emergency</span>  Ambulance Booking Service.</p>
        <hr/>
