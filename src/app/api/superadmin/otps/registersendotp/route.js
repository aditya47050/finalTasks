...
export async function POST(request) {
  ...
  await db.SuperAdminRegisterOtp.create({
    data: { email, otp },
  });
  ...
  const mailOptions = {
    ...
    to: email,
    subject:
      "Welcome to Aarogya Aadhar – Your Account Successfully Created!",
    html: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6;">
        ...
        <ol>
          <li>Go to the registration page: <a href="https://aarogyaaadhar.com/auth/register" target="_blank">Registration Page</a></li>
